...
def derive_balanced_set_cot():
    ...
    test_no_cot_path= "/cot_true_with_options_9666_aqua_rag/test_set/CoT_False/deepmind-aqua_rat_6k.xlsx"
...
folder_path = f"/cot_true_with_options_9666_aqua_rag/test_set/CoT_{CoT}/with_options/"
