...
if __name__ == "__main__":
    ...
    df = pd.read_excel("../olympiad/olympiad_11000.xlsx")
    df = drop_nasty_samples(df)
    df.to_excel(f"../olympiad/olympiad_11k_cleaned.xlsx", index=False)
    ...
    df.to_excel(f"../olympiad/olympiad_11k_llm_labelled{len(df)}.xlsx", index=False)
